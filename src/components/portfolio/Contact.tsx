...
export const Contact = () => (
  <section id="contact" className="container mx-auto px-6 py-24 md:py-40 scroll-mt-20">
    <div className="max-w-3xl mx-auto text-center space-y-12">
      ...
      {/* Terminal Form Style */}
      <div className="glass-panel p-8 space-y-8 text-left font-mono text-sm max-w-xl mx-auto shadow-[0_8px_40px_rgba(0,0,0,0.5)]">
        <div className="space-y-6">
        ...
        <button className="w-full bg-[#00FFD1]/10 border border-[#00FFD1]/40 text-[#00FFD1] py-4 hover:bg-[#00FFD1]/20 transition-all font-bold tracking-[0.2em] magnetic">
          [ TRANSMIT MESSAGE ──→ ]
        </button>
      </div>
      ...
      <div className="flex justify-center gap-8 pt-12">
        {portfolio.socials.github && (
          <a href={portfolio.socials.github} target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#00FFD1] transition-colors magnetic">
            <Github className="size-6" />
          </a>
        )}
        {portfolio.socials.linkedin && (
          <a href={portfolio.socials.linkedin} target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#00FFD1] transition-colors magnetic">
            <Linkedin className="size-6" />
          </a>
        )}
        {portfolio.socials.twitter && (
          <a href={portfolio.socials.twitter} target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#00FFD1] transition-colors magnetic">
            <Twitter className="size-6" />
          </a>
        )}
        <a href={`mailto:${portfolio.email}`} className="text-white/40 hover:text-[#00FFD1] transition-colors magnetic">
