...
export const AuroraBackground = () => {
  ...
  useFrame((state) => {
    ...
    // Performance: Fade out background as we scroll to deep sections
    // Keep it slightly visible for atmosphere
  ...
  return (
    <mesh ref={meshRef} position={[0, 0, -20]} scale={[viewport.width * 10, viewport.height * 10, 1]}>
